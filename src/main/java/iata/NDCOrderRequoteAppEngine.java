...
@WebServlet(name = "NDCOrderRequoteAppEngine", urlPatterns = { "/ndcrequote" })

public class NDCOrderRequoteAppEngine extends HttpServlet {
		...
		if (request != null) {
			...
			if(pnr !=null ) {
				...
				if(airline.equals("BA"))
					str = TestClient.ndcOrderRequote(pnr, airline, appConfig.baKey,null,null, appConfig.baUrl+"/OrderReshop/"+appConfig.baVersion, "OrderReshop17_2_V1");
				else if(airline.equals("PC"))
					str = TestClient.ndcOrderRequote(pnr, airline,null, appConfig.pcUsername, appConfig.pcPassword,appConfig.pcUrl, "cranendc/doCancelPreviewRequest");
